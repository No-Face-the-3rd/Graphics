...
void main()
{
	...
	gallery.loadShader("sPass", "../res/shaders/sPass.vs", "../res/shaders/sPass.fs", true, false, false);
	gallery.loadShader("lSPass", "../res/shaders/lSPass.vs", "../res/shaders/lSPass.fs", false, true);
